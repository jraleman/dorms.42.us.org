var mapLocation = new google.maps.LatLng(37.5534637, -122.0553239);
var marker;
var map;
...
function initialize() {
  ...
  var contentString = '<div class="map-info">' +
    '<div class="map-title">' +
    '<div class="brand" href="#"><img alt="" src="images/logo/nostromo.png"><div class="brand-info"><div class="brand-name">bauhaus</div><div class="brand-text">architecture</div></div></div></div>' +
    '<p class="map-address">' +
